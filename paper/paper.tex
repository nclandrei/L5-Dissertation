...
\begin{itemize}
  \item it is one of the very few research projects that investigates such a large number of tickets (over 3200,000) spanning
...
have been helpful in conducting the analysis. However, in addition to the fields we saved, we also store grammar correctness scores 
(i.e. number of grammar mistakes identified in summary, description and comments), sentiment scores (i.e. sentiment drawn from summary 
and description), whether they have steps to reproduce, if stack traces are present and number of words in comments, summary and description. 
...
\begin{figure}
  \begin{center}
  \includegraphics[scale=0.2]{images/attachments.png}
  \end{center}
  \caption{\label{fig-eg}Application flow of the Go tool.}
  \end{figure}
...
\begin{figure}
  \begin{center}
  \includegraphics[scale=0.2]{images/comment_complexity.png}
  \end{center}
  \caption{\label{fig-eg}Application flow of the Go tool.}
  \end{figure}
...
\begin{figure}
  \begin{center}
  \includegraphics[scale=0.2]{images/fields_complexity.png}
  \end{center}
  \caption{\label{fig-eg}Application flow of the Go tool.}
  \end{figure}
...
\begin{figure}
  \begin{center}
  \includegraphics[scale=0.2]{images/grammar_correctness.png}
  \end{center}
  \caption{\label{fig-eg}Application flow of the Go tool.}
  \end{figure}
...
\begin{figure}
  \begin{center}
  \includegraphics[scale=0.2]{images/sentiment_analysis.png}
  \end{center}
  \caption{\label{fig-eg}Application flow of the Go tool.}
  \end{figure}
...
\begin{figure}
  \begin{center}
  \includegraphics[scale=0.2]{images/steps_to_reproduce.png}
  \end{center}
  \caption{\label{fig-eg}Application flow of the Go tool.}
  \end{figure}
...
\begin{figure}
  \begin{center}
  \includegraphics[scale=0.2]{images/stack_traces.png}
  \end{center}
  \caption{\label{fig-eg}Application flow of the Go tool.}
  \end{figure}
...
% \begin{figure}
% \begin{center}
% \includegraphics[scale=0.32]{images/alice.pdf}
% \end{center}
