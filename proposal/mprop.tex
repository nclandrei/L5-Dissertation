...
tickets most probably via REST APIs, however the final list of projects
will be finalized once some tests will be run. Then, define what makes for 2 similar tickets
